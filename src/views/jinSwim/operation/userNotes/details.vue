    ...
    <div class="compileMain">
      <el-form :model="noticeForm" :rules="noticeRules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
        <el-form-item label="模板名称：" prop="noticeName">
          <el-input disabled style="width: 350px;" v-model="noticeForm.noticeName"></el-input>
        </el-form-item>
        <el-form-item label="电话：" prop="noticePhone">
          <el-input disabled style="width: 350px;" v-model="noticeForm.noticePhone"></el-input>
        </el-form-item>
        <el-form-item label="发货时间：" prop="noticeDeliveryTime">
          <el-input disabled type="textarea" v-model="noticeForm.noticeDeliveryTime"></el-input>
        </el-form-item>
        <el-form-item label="价格说明：" prop="noticePriceDescription">
          <el-input disabled type="textarea" v-model="noticeForm.noticePriceDescription"></el-input>
        </el-form-item>
        <el-form-item label="关于快递：" prop="noticeExpressInstructions">
          <el-input disabled type="textarea" v-model="noticeForm.noticeExpressInstructions"></el-input>
        </el-form-item>
        <el-form-item label="签收提醒：" prop="noticeSignReminder">
          <el-input disabled type="textarea" v-model="noticeForm.noticeSignReminder"></el-input>
        </el-form-item>
        <el-form-item label="退换问题：" prop="noticeReturnExchange">
          <el-input disabled type="textarea" v-model="noticeForm.noticeReturnExchange"></el-input>
        </el-form-item>
        <el-form-item label="温馨提示：" prop="noticeReminder">
          <el-input disabled type="textarea" v-model="noticeForm.noticeReminder"></el-input>
        </el-form-item>
      </el-form>
    </div>
  </div>
