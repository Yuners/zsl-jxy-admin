  ...
  <div class="compile">
    ...
    <div class="compileMain">
        ...
        <div class="block-main">
          <el-radio-group @change="handle" style="display: flex" v-model="form.villagePropagandaType">
            <div class="item">
              ...
              <el-radio disabled label="视频">视频</el-radio>
            </div>
            <div class="item">
              <span class="block_icon el-icon-picture"></span>
              <el-radio disabled label="图片">图片</el-radio>
            </div>
          </el-radio-group>
          <div class="hint">
          ...
          <div class="uploadItem">
            <template v-if="form.villagePropagandaType == '视频'">
              <CustomUpload :disabled="true" :limit="1" :fileList="form.villageDescribeList" uploadType="video" @succeed="videoSucce" @deleteImage="videoImage"></CustomUpload>
            </template>
            <template v-if="form.villagePropagandaType == '图片'">
              <CustomUpload :disabled="true" :limit="20" :fileList="form.villageDescribeList" @succeed="imageSucce" @deleteImage="deleteImage"></CustomUpload>
            </template>
          </div>
        </div>
      </div>
      <div class="textIntroduction">
        ...
        <div class="richText" v-html="form.villageIntroduction">
        </div>
      </div>
    </div>
